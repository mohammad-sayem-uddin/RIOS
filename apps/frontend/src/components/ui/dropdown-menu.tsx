/**
 * RIOS — Dropdown Menu Component
 *
 * Accessible dropdown menu built on Radix. Used for the user/profile menu and
 * contextual action menus across the application shell.
 */
